...
<body background="imagens/fundo.jpg">
	...
	<div id="areacompra">
	<div style="text-align:center; color:#d3d3d3;"><h1> Faça seu cadastro para realizar o seu pedido!!!</h1></div><br><hr><br>
	<div style="text-align:center; color:#4f4f4f;"><h2>Cervejas</h2></div>
	<a  href="pedido?cod_produto=1"><img class="imgproduto" src="imagens/Skol.jpeg"></a>
	<a  href="pedido?cod_produto=2"><img class="imgproduto" src="imagens/Budweiser.jpeg"></a>
	<a  href="pedido?cod_produto=3"><img class="imgproduto" src="imagens/Heineken.jpeg"></a>
	<a  href="pedido?cod_produto=4"><img class="imgproduto" src="imagens/Corona.jpeg"></a><br><hr><br>
	...
	<div style="text-align:center; color:#4f4f4f;"><h2>Vinhos</h2></div>
	<a  href="pedido?cod_produto=9"><img class="imgproduto" src="imagens/Pergola.jpeg"></a>
	<a  href="pedido?cod_produto=10"><img class="imgproduto" src="imagens/Calle.jpeg"></a>
	<a  href="pedido?cod_produto=11"><img class="imgproduto" src="imagens/Malage.jpeg"></a>	<br>	
	</div>
	<div id="rodape">
